...
function Home() {
    ...
    return (
        <>        
            {/* Slides per view */}
            <div className="relative flex items-center flex-col justify-center px-5 md:px-10 pt-28 pb-20 md:pb-20 md:pt-36 lg:pt-52 lg:pb-40 font-[poppins]" ref={homeSection} style={{background:`linear-gradient(to bottom,rgba(0,6,6,0.9),rgba(0,3,6,0.7)), url(${Bg})`, backgroundAttachment:"fixed", backgroundPosition:"center", backgroundSize:"cover"}}>
